...
// Ambil data dari tabel lapangan_212096
$query = "SELECT * FROM lapangan_212096";
    ...
    <div class="page-wrapper">
        ...
        <div class="card mb-0">
            <div class="card-body">
                ...
                <!-- Tombol Tambah Data -->
                <a href="tambahlapagan.php" class="btn btn-primary mb-3">Tambah Data</a>
                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <td><?php echo $no++; ?></td>
                                    <!-- <td><?php echo htmlspecialchars($row['idlapangan_212096']); ?></td> -->
                                    <td><?php echo htmlspecialchars($row['namalapangan_212096']); ?></td>
                                    <td><?php echo "Rp " . number_format($row['harga_212096'], 0, ',', '.'); ?></td>

                                    <td>
                                        <img src="/lapanganbadminton/img/inputan/<?php echo htmlspecialchars(basename($row['gambar_212096'])); ?>" alt="Gambar Lapangan" width="100">
                                    </td>
                                    <td><?php echo htmlspecialchars($row['tanggal_waktu_212096']); ?></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
